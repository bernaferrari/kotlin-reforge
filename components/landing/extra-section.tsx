                    ...
                    <div className="flex flex-col justify-between gap-8 p-6 sm:p-8 lg:p-10">
                        <div>
                            <div className="flex items-center gap-3">
                                ...
                                <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-primary">Library</p>
                            </div>
                            <h3 className="mt-5 text-3xl font-semibold tracking-tight sm:text-4xl">Diagonal Wipe Icon</h3>
                    ...
                    <div className="flex items-center justify-center border-t border-border/60 bg-gradient-to-br from-muted/40 via-transparent to-muted/20 p-6 sm:p-8 lg:border-l lg:border-t-0 lg:p-10">
                        <div className="relative aspect-video w-full overflow-hidden rounded-xl border border-border/60 bg-background/40">
                            <Image
                                ...
                                unoptimized
                            />
                            <span aria-hidden className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-white/5" />
                        </div>
                    </div>
                </div>
            </article>
